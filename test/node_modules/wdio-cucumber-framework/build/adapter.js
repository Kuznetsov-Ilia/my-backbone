    ...
    _createClass(CucumberAdapter, [{
        ...
        value: function getStepDefinition() {
            ...
            return function (pattern, options, code, uri, line) {
                /**
                 * don't fiberify the step definition if function name is async
                 */
                if (code.name === 'async') {
                    return origStepDefinition(pattern, options, code, uri, line);
                }

                var stepDefinition = origStepDefinition(pattern, options, _this.wrapStep(code), uri, line);
        ...
        value: function getAstTreeWalker() {
            ...
            return function (features, supportCodeLibrary, listeners, options) {
                supportCodeLibrary.setDefaultTimeout(_this2.cucumberOpts.timeout);
                return origAstTreeWalker(features, supportCodeLibrary, listeners, options);
            };
        }
    }, {
        key: 'wrapStep',
        value: function wrapStep(code) {
            return function () {
                var _this3 = this;
                ...
                return new _Promise(function (r) {
                    return global.wdioSync(code, r).apply(_this3, args);
                });
            };
        }
    }]);
